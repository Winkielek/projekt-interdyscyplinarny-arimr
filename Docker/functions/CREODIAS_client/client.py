...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, 'hdfxs:r:c:p:t:e:i:l:z:n:',
                                   ['help, download, find, delete, satellite=', 'records=', 'clouds=', 'position=',
                                    'start_date=', 'end_date=', 'diff_days=', 'proc_level=', 'resize=', 'name='])
